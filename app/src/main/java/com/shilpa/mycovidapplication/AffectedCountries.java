...
public class AffectedCountries extends AppCompatActivity {
    ...
    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            startActivity(new Intent(getApplicationContext(),Information.class).putExtra("position",position));
        }
    });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0;i<jsonArray.length();i++){
                                ...
                                countryModel = new CountryModel(flagUrl,countryName,cases,totalCases,deaths,totalDeaths,recovered,active,critical);
